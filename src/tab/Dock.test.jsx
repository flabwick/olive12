...
describe('Dock', () => {
  ...
  it('calls onScrollTop when caret button is clicked', async () => {
    ...
    wrap(<Dock onScrollTop={onScrollTop} />)
  ...
  it('calls onTabOverview when tab overview button is clicked', async () => {
    ...
    wrap(<Dock onTabOverview={onTabOverview} />)
